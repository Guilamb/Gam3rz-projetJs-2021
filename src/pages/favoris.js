...
export default class favoris extends Page {
	...
	render() {
		const listeFavorisTemp = localStorage.getItem('favoris');
		const listeFavoris = JSON.parse(listeFavorisTemp);
		let finalHtml = '<div class="row align-items-start">';
		listeFavoris.forEach(element => {
			console.log(element);
			finalHtml += `
			...
			<div class="col-3 flip-card">
				...
				<img class="fav" style="visibility: hidden">
				</div>
				...
				<li class="list-group-item">note : ${element.metacritic}</li>
				</ul>
				<div class="wrapper">
				<a class="cta" href="details-cyberpunk-2077">
				<span>DETAILS</span><span><svg width="66px" height="43px" viewBox="0 0 66 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><g id="arrow" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
